            ...
            <div className="login-contain">
                ...
                <div className="left-side">
                    ...
                    <div className="img-class">
                        <h1 className='textWhite'><u>Verify Acount</u></h1>
                    </div>

                    <form className='formStyle' onSubmit={handlesubmit}>
                        <label>We have sent an email to {emailEntered} to make sure you own the account. Please check your inbox and enter the verification code below to finish creating your account..</label>
